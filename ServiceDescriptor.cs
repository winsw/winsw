...
namespace winsw
{
    ...
    public class ServiceDescriptor
    {
        ...
        /// <summary>
        /// Enables mapping of working directory.
        /// </summary>
        public bool MapSharedFolder {
            get {
                var wd = SingleElement("mapDirectory", true);
                return String.IsNullOrEmpty(wd) ? false : wd.Equals("true");
            }
        }
        ...
        /// Enables mapping of working directory.
        /// </summary>
        public bool MapToolsFolder
        {
            get
            {
                var wd = SingleElement("mapToolsDirectory", true);
                return String.IsNullOrEmpty(wd) ? false : wd.Equals("true");
            }
        }

        /// <summary>
        /// Label of shared folder to be mounted
        /// </summary>
        public String MapSharedFolderLabel {
            get {
                var wd = SingleElement("mapDirectoryLabel", !MapSharedFolder);
                return String.IsNullOrEmpty(wd) ? "" : wd;
            }
        }
        
        /// <summary>
        /// UNC path to shared folder
        /// </summary>
        public String MapSharedFolderPath {
            get {
                var wd = SingleElement("mapDirectoryPath", !MapSharedFolder);
                return String.IsNullOrEmpty(wd) ? "" : wd;
            }
        }
        ...
        /// UNC path to shared folder
        /// </summary>
        public String MapToolsDirectoryLabel
        {
            get
            {
                var wd = SingleElement("toolsDirectoryLabel", !MapToolsFolder);
                return String.IsNullOrEmpty(wd) ? "" : wd;
            }
        }
        ...
        /// UNC path to shared folder
        /// </summary>
        public String MapToolsFolderPath
        {
            get
            {
